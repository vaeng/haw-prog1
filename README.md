# Santorini with a Custom Engine

This project is split in two parts:

- a custom engine built with C++23 and SFML 3.0,
- and the actual game: Santorini - a board game to digital conversion.

## Documentation

- **[Setup Guide](docs/SetupGuide.md)** — How to build and run
- **[Architecture Overview](docs/ArchitectureOverview.md)** — Class hierarchy and lifecycle
